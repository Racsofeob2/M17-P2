...
if (isset($_POST['submit'])) {
    if ($_FILES['input_image']['error'] !== UPLOAD_ERR_OK) {
        die('<div class="alert alert-danger">Error: Fallo en la subida del archivo.</div>');
    }
    ...
    if (!empty($fileName)) {
        ...
        if (!array_key_exists($fileType, $allowedTypes) || !in_array($fileExt, $allowedExtensions)) {
            die('<div class="alert alert-danger">Error: Tipo de archivo no permitido.</div>');
        }
